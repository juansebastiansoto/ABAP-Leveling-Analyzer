class YCL_BC_LEVELING_FUNC definition
  public
...
CLASS YCL_BC_LEVELING_FUNC IMPLEMENTATION.
...
METHOD get_object_content.
  ...
  IF me->object-obj_name(5) EQ 'TABLE'. " SM30 Function Module
